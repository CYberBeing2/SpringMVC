...
<body>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                      <a href="${pageContext.request.contextPath }/selectTransferBefore.action"><i class="fa fa-edit "></i>查询账单 <span class="badge"></span></a>
                    </li>
                </ul>
                            </div>
        </nav>
  ...
  <form action="${pageContext.request.contextPath }/transferAfter.action" class="am-form" method="post">
        
         <div class="col-lg-6 col-md-6">
					<div class="table-responsive">
<label> 使用的银行卡：  </label>
								<c:forEach items="${bankcardList }" var="bankcard">
									<div><input type="radio" value="${bankcard.bcid}" name="bcid">银行卡:${bankcard.bcid }</div>
								</c:forEach>
				</div>
		
<div>
<label> 对方银行卡  </label>
<input type="text" name="counterBankcard" />
</div>
<div>
<label> 交易金额： </label>		
