						...
						<table class="table">
							...
							<tbody>
								...
								<c:forEach items="${transferList }" var="transferlist">
									<tr class="info">
										<td>${transferlist.tid }</td>
										<td>${transferlist.toutid }</td>
										<td>${transferlist.tinid }</td>
										<td>${transferlist.tmoney }</td>
										<td>${transferlist.tdate }</td>
									</tr>
								</c:forEach>
							</tbody>
						</table>
						  <a href="${pageContext.request.contextPath }/typeTransferList.action">打印</a>
				</div>
			</div>
        </div>    
