        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                     ...
                     <li> 
                        <a href="index.html" ><i class="fa fa-desktop "></i>用户列表 <span class="badge"></span></a>
                    </li>
                   
                    <li class="active-link">
                        <a href="${pageContext.request.contextPath }/items/editItems.action?id=${item.id}"><i class="fa fa-table "></i>个人信息 <span class="badge"></span></a>
                    </li>
                    <li>
